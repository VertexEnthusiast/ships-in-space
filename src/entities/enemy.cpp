...
Enemy::Enemy(int x, int y, const char* texturePath, struct FrameData* frameInfo, int health, int speed) :
Animated(x, y, texturePath, frameInfo), health(health), speed(speed) {
